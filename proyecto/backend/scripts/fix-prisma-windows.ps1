...
# Ejecutar como Administrador: PowerShell -ExecutionPolicy Bypass -File fix-prisma-windows.ps1

Write-Host "Solucionando errores de Prisma en Windows..." -ForegroundColor Cyan
